    ...
    public class AssetFinderAttributeDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Color wrapBg = EditorGUIUtility.isProSkin
                ? EditorSolidColors.Base300
                : new Color(0.78f, 0.78f, 0.78f, 1f);
            Color wrapBorder = EditorGUIUtility.isProSkin
                ? EditorSolidColors.Border
            ...
            else
            {
                ...
                for (int i = 0; i < state.Filters.Count; i++)
                {
                    ...
                    Color rowBg = EditorGUIUtility.isProSkin
                        ? ((i & 1) == 0 ? EditorSolidColors.Base200 : EditorSolidColors.Base300)
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            root.style.backgroundColor = EditorSolidColors.Base300;
            root.style.borderTopWidth = 1f;
            root.style.borderBottomWidth = 1f;
            root.style.borderLeftWidth = 1f;
            root.style.borderRightWidth = 1f;
            root.style.borderTopColor = EditorSolidColors.Border;
            root.style.borderBottomColor = EditorSolidColors.Border;
            root.style.borderLeftColor = EditorSolidColors.Border;
            root.style.borderRightColor = EditorSolidColors.Border;
