...
namespace CupkekGames.AssetFinder.Editor
{
    ...
    public class AssetFinderToolbar : VisualElement
    {
        ...
        private void BuildUI()
        {
            ...
            style.borderTopColor = EditorSolidColors.Border;
        ...
        private VisualElement CreateFilterRow(int index)
        {
            ...
            row.style.backgroundColor = EditorSolidColors.Base200;
        ...
        private Label CreateHint(string text)
        {
            ...
            hint.style.color = EditorSolidColors.TextMuted;
        ...
        private VisualElement CreateLabelBadge(string label, Action onRemove)
        {
            ...
            badge.style.backgroundColor = EditorSolidColors.Primary;
